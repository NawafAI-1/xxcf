...
export default function Panel({
  ...
  return (
    <section
      className={`rounded-2xl bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-20px_rgba(15,23,42,0.35)] ring-1 ring-slate-200/80 sm:p-6 ${className}`}
    >
      ...
      {children}
      {footnote ? <p className="mt-5 text-xs leading-relaxed text-slate-500">{footnote}</p> : null}
    </section>
  );
}
