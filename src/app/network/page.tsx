  ...
  return (
    <div>
      <PageHeader
        ...
        description={`Every dataset as a node, colored by domain. Solid lines are explicit lineage: one dataset derived from another, with ${stats.lineageLinks} recorded so far. Dashed lines connect datasets that share a theme or keyword, which is where unexpected reuse tends to show up.`}
      />
